...
<nav><center>
 ...
 <center><div class="slider">
    <ul>
      <li>
<img height="290" width="433" src="asombro.gif" alt="">
</li>
      <li>
<img height="290" width="433" src="new.JPG" alt="">
</li>
      <li>
<img height="290" width="433" src="lokki.JPG" alt="">
</li>
      <li>
<img height="290" width="433" src="arete.JPG" alt="">
</li>
    </ul>
    <hr/>
  </div></center>
	<?php
            ...
            $query = "SELECT *FROM productos order by idproducto desc limit 5 ";
            $resultado = $conexion->query($query);
        ...
        ?>
             ...
             <p><a href="agregar_carrito.php?id=<?php echo  $row['idproducto'];?>" ><input type="button" value="Comprar"></a> </p>
